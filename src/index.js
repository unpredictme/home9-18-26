...
function makePrediction(email,answers,date=new Date().toISOString().slice(0,10)){
 ...
 if(s.testLike){
   return {
     ...
     signal:"Random-looking handle detected. We’d rather call it than fake a prediction.",testLike:true
   };
 }
 const traits=[];
