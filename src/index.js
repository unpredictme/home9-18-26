...
(function(){
  ...
  function renderQuestion(){
    ...
    app.innerHTML=
      '<div class="progress"><div class="bar" style="width:'+(((answers.length+1)/questions.length)*100)+'%"></div></div>'+
      '<div class="qnum">QUESTION '+(answers.length+1)+' OF '+questions.length+'</div>'+
    ...
    Array.prototype.forEach.call(app.querySelectorAll(".answer"),function(btn){
      btn.onclick=function(){
        ...
        if(answers.length===questions.length) submitPrediction();
        else renderQuestion();
      };
    });
  }
