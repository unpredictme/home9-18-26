...
const html=`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>UnPredictMe — Unpredictable Predictions About You</title><link rel="canonical" href="https://unpredictme.com/"><meta name="description" content="UnPredictMe makes playful, unpredictable predictions about you from tiny patterns in your email. Get a guess, see if it fits, and come back tomorrow."><meta property="og:type" content="website"><meta property="og:site_name" content="UnPredictMe"><meta property="og:title" content="UnPredictMe — Unpredictable Predictions About You"><meta property="og:description" content="A playful, unpredictable prediction about you from one tiny clue: your email."><meta property="og:url" content="https://unpredictme.com/"><meta name="twitter:card" content="summary"><meta name="twitter:title" content="UnPredictMe — Unpredictable Predictions About You"><meta name="twitter:description" content="A playful, unpredictable prediction about you from one tiny clue: your email."><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebSite","name":"UnPredictMe","url":"https://unpredictme.com/","description":"A playful prediction service that makes unpredictable guesses about you from tiny patterns in your email address.","publisher":{"@type":"Organization","name":"UnPredictMe","url":"https://unpredictme.com/"}}</script><script async src="https://www.googletagmanager.com/gtag/js?id=G-PHWL785Q3F"></script><script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag("js",new Date());gtag("config","G-PHWL785Q3F");</script><meta name="robots" content="index,follow,max-image-preview:large"><style>
:root{--ink:#123a36;--muted:#58716d;--aqua:#78e6d5;--cream:#f7fffd;--line:#b9ebe3}*{box-sizing:border-box}html{min-height:100%;background:var(--cream)}body{margin:0;min-height:100vh;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink);overflow-x:hidden}body:before,body:after{content:"";position:fixed;width:42vw;height:42vw;border-radius:50%;filter:blur(55px);opacity:.48;z-index:-2;animation:float 12s ease-in-out infinite alternate}body:before{background:#9af3e4;top:-13vw;left:-8vw}body:after{background:#c8e8ff;right:-12vw;bottom:-14vw;animation-delay:-5s}@keyframes float{to{transform:translate(30px,25px) scale(1.08)}}main{min-height:calc(100vh - 82px);display:flex;align-items:center;justify-content:center;padding:42px 18px}.shell{width:min(720px,100%);text-align:center}.eyebrow{font-size:12px;font-weight:800;letter-spacing:.16em;text-transform:uppercase;color:#168d82}h1{font-size:clamp(58px,13vw,112px);line-height:.84;letter-spacing:-.075em;margin:16px 0 20px}.lede{font-size:clamp(20px,3vw,27px);line-height:1.35;color:var(--muted);max-width:600px;margin:0 auto 30px}.card{position:relative;overflow:hidden;text-align:left;background:rgba(255,255,255,.88);border:1px solid rgba(185,235,227,.95);border-radius:32px;padding:clamp(25px,5vw,48px);box-shadow:0 25px 80px rgba(26,104,95,.12);backdrop-filter:blur(16px)}.signal-bar{display:flex;gap:8px;flex-wrap:wrap;justify-content:center;margin:18px 0}.signal-chip{padding:8px 11px;border-radius:999px;background:#f1fffc;border:1px solid var(--line);color:#53746f;font-size:12px;font-weight:750}.reading-line{min-height:28px;color:#58716d;font-size:15px}.reveal{animation:reveal .55s ease both}@keyframes reveal{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:none}}.address-preview{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:14px;color:#168d82;word-break:break-all;text-align:center;margin:12px auto 0;max-width:560px}.machine{height:96px;display:flex;align-items:center;justify-content:center;gap:16px;margin:-8px 0 8px;position:relative}.machine:before{content:"";position:absolute;width:130px;height:130px;border:1px solid rgba(120,230,213,.5);border-radius:50%;animation:spin 9s linear infinite}.machine:after{content:"";position:absolute;width:180px;height:180px;border:1px dashed rgba(120,230,213,.35);border-radius:50%;animation:spin 14s linear infinite reverse}@keyframes spin{to{transform:rotate(360deg)}}.machine span{position:relative;z-index:1;display:grid;place-items:center;width:56px;height:56px;border-radius:19px;background:#effffb;border:1px solid var(--line);font-size:27px;box-shadow:0 10px 30px rgba(30,120,110,.08);animation:bob 3s ease-in-out infinite}.machine span:nth-child(2){width:70px;height:70px;border-radius:23px;background:var(--aqua);font-size:36px;animation-delay:-1.1s}.machine span:nth-child(3){animation-delay:-2s}@keyframes bob{50%{transform:translateY(-7px) rotate(3deg)}}.qnum{font-size:12px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#4eaaa0;text-align:center}.question{font-size:clamp(30px,6vw,46px);line-height:1.05;letter-spacing:-.04em;margin:10px 0 12px;text-align:center}.intro{color:var(--muted);line-height:1.55;margin:0 auto 20px;max-width:540px;font-size:16px;text-align:center}.email{display:flex;gap:10px;margin-top:22px}.email input{min-width:0;flex:1;border:1px solid var(--line);border-radius:15px;padding:17px;font-size:16px;background:#fff;color:var(--ink)}button{font-family:inherit}.primary,.secondary{border:0;border-radius:16px;padding:17px;font-size:16px;font-weight:800;cursor:pointer;transition:.18s transform,.18s box-shadow}.primary{background:var(--ink);color:#fff}.secondary{background:#e5f7f3;color:var(--ink)}.primary:hover,.secondary:hover{transform:translateY(-2px);box-shadow:0 9px 25px rgba(30,120,110,.12)}.consent{display:flex;gap:9px;align-items:flex-start;text-align:left;font-size:12px;color:#718783;margin:12px 2px 0}.consent input{margin-top:2px}.helper{font-size:13px;color:#78908d;text-align:center;margin:18px 0 0}.micro-actions{display:flex;justify-content:center;gap:8px;flex-wrap:wrap;margin:15px 0 0}.micro{border:1px solid var(--line);background:#f7fffd;color:#50736e;border-radius:999px;padding:8px 11px;font-size:12px;font-weight:700;cursor:pointer;transition:.18s transform,.18s background}.micro:hover{transform:translateY(-2px);background:#edfffb}.spark{display:inline-block;animation:spark 1.8s ease-in-out infinite}@keyframes spark{50%{transform:scale(1.18) rotate(10deg)}}.reading{text-align:center}.pulse{display:flex;justify-content:center;gap:7px;margin:28px}.pulse i{display:block;width:9px;height:9px;border-radius:50%;background:var(--aqua);animation:pulse 1s infinite}.pulse i:nth-child(2){animation-delay:.15s}.pulse i:nth-child(3){animation-delay:.3s}@keyframes pulse{50%{transform:translateY(-8px);opacity:.45}}.prediction{background:#f1fffc;border:1px solid var(--line);border-radius:24px;padding:25px;margin:24px 0}.prediction h3{font-size:25px;margin:0 0 10px}.prediction p{font-size:19px;line-height:1.6;color:#42635f;margin:0}.prediction-mark{font-size:28px;color:#168d82;margin-bottom:8px}.buttons{display:grid;gap:10px}.feedback{text-align:center;color:#168d82;font-weight:700;margin:16px 0 0}.page{max-width:760px;margin:0 auto;text-align:left}.page h2{font-size:clamp(32px,6vw,52px);letter-spacing:-.045em;text-align:center;margin:8px 0 20px}.page h3{font-size:20px;margin:28px 0 8px}.page p,.page li{color:#4f6965;line-height:1.7;font-size:16px}.page ul{padding-left:22px}.price{font-size:42px;font-weight:900;letter-spacing:-.05em;text-align:center;margin:15px 0}.brand{position:fixed;top:20px;left:22px;z-index:20;display:flex;align-items:center;gap:9px;color:var(--ink);text-decoration:none;font-weight:900;letter-spacing:-.035em;font-size:15px}.brand-mark{display:grid;place-items:center;width:34px;height:34px;border-radius:12px;background:var(--ink);color:var(--aqua);font-size:19px;box-shadow:0 8px 24px rgba(26,104,95,.16);transform:rotate(-4deg)}.brand:hover .brand-mark{transform:rotate(4deg) scale(1.04)}footer a{color:#4e7771;text-decoration:none;font-size:13px;font-weight:700}footer a:hover{text-decoration:underline}.seo-copy{padding:10px 18px 34px}.seo-copy>div{width:min(760px,100%);margin:0 auto;padding:26px 28px;border:1px solid rgba(185,235,227,.9);border-radius:24px;background:rgba(255,255,255,.68)}.seo-copy h2{font-size:clamp(28px,5vw,40px);letter-spacing:-.04em;margin:0 0 12px}.seo-copy h3{font-size:20px;margin:24px 0 7px}.seo-copy p{color:#4f6965;line-height:1.7;font-size:16px;margin:10px 0}footer{padding:28px 18px 36px;text-align:center;color:#78908d;font-size:12px}footer .links{display:flex;justify-content:center;gap:16px;flex-wrap:wrap;margin-bottom:10px}@media(max-width:560px){.brand{top:14px;left:14px;font-size:14px}.brand-mark{width:32px;height:32px}main{padding:76px 14px 28px}.card{border-radius:25px}.email{display:grid}.email button{padding:16px}}
</style></head><body><a class="brand" href="/" aria-label="UnPredictMe home"><span class="brand-mark">?</span><span>UnPredictMe</span></a><main><div class="shell" id="app"></div></main><section class="seo-copy" aria-label="About UnPredictMe"><div><h2>What is UnPredictMe?</h2><p><strong>UnPredictMe</strong> is a playful prediction experience built around the idea of making an <strong>unpredictable guess about you</strong> from one tiny clue: your email address.</p><p>It is not a personality test, a birth chart, or a claim that an email address can reveal who you really are. UnPredictMe looks at simple visible patterns such as the shape, length, punctuation, and numbers in an email address, then turns those signals into a surprising prediction.</p><h3>Why is it unpredictable?</h3><p>The prediction is intentionally playful. You do not know which reading the machine will make before you try it, and you can tell UnPredictMe whether the guess feels like you. Come back another day for another unpredictable prediction.</p></div></section><footer><div class="links"><a href="/">Predict</a><a href="/about">About</a><a href="/pricing">Pricing</a><a href="/contact">Contact</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a></div><div>© 2026 UnPredictMe</div></footer><script>
(function(){
  var predictions=[
    ["The Quiet Decider","Your address has the energy of someone who thinks before they commit — then moves faster than anyone expects once the decision is made."],
    ["The Open Door","There is something unusually inviting about the way your address comes together. Your next useful opportunity may arrive through a person or idea you almost overlook."],
